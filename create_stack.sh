...
STACK_NAME="AMICreation"
STACK_BUCKET_PATH="cf.awsguy.solutions/cf-ami-creation"
MASTER_STACK_FILE_NAME="master.yaml"
TAGS="Key=auto-delete,Value=no"
PARAMETERS="ParameterKey=SMVPCSubnetImportedKeyId,ParameterValue=VPCs-DevelopmentVpc-1NZ7V023X571T-PrivateSubnet1 ParameterKey=NotificationEmail,ParameterValue=$USER@amazon.com"
